...
Het meest eenvoudige model voor een ideale zonnecel bestaat uit een foto-eletrische stroombron en een diode~\cite{bellia} en is ge\"illustreerd in Fig.~\ref{fig:model}.
